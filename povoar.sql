...
VALUES ((SELECT contentID FROM Content WHERE contentname = "The Office - First Episode"),
		...
		2,(SELECT seasonnumber FROM Season WHERE showname = "Mr Robot" AND seasonnumber = 1)),
		...
		2,(SELECT seasonnumber FROM Season WHERE showname = "Peaky Blinders" AND seasonnumber = 5)),
...
VALUES 	((SELECT profileID FROM Profile WHERE profilename = "Diogo Nunes"),
				...
				((SELECT profileID FROM Profile WHERE profilename = "Rodrigo Monteiro"),
				(SELECT contentID FROM Content WHERE contentname = "John Wick"),
				'10-01-2022',"17:45","1:41:00",5),

				((SELECT profileID FROM Profile WHERE profilename = "Abel Asdrubal"),
				(SELECT contentID FROM Content WHERE contentname = "The Office - m1rr0r1ng"),
				'30-12-2021',"13:10","30:18",4),

				((SELECT profileID FROM Profile WHERE profilename = "Abel Asdrubal"),
				(SELECT contentID FROM Content WHERE contentname = "The Office - zer0-day"),
